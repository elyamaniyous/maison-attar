...
export default async function ProductDetailPage({
  ...
  return (
    <main className="min-h-screen bg-cream">
      ...
      <section className="px-6 md:px-12 lg:px-20 pb-20">
        <div className="max-w-screen-xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-12 xl:gap-20">
            ...
            {/* Right: Product Info */}
            <div className="animate-fade-up delay-100 lg:pt-4">
              {/* Category */}
      ...
      {maalem && (
        <section className="border-t border-border bg-cream-dark">
          <div className="max-w-screen-xl mx-auto px-6 md:px-12 lg:px-20 py-20">
            <p className="text-xs uppercase tracking-widest text-gold font-body mb-12 animate-fade-up">
              L'Artisan
            </p>
            <div className="grid grid-cols-1 md:grid-cols-[1fr_1.5fr] gap-12 lg:gap-20 items-center">

              {/* Maalem photo placeholder */}
              <div className="animate-fade-up delay-100">
                <div className="aspect-[3/4] bg-warm-gray relative overflow-hidden">
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-4">
                    {/* Monogram-style placeholder */}
                    <div className="w-20 h-20 rounded-full bg-warm-gray-light border border-border flex items-center justify-center">
              ...
              <div className="animate-fade-up delay-200 space-y-6">
                <div>
                  ...
                  <p className="text-sm text-gold font-body uppercase tracking-widest">
                ...
                <div className="grid grid-cols-3 gap-6 pt-2">
                  <div>
                    ...
                    <p className="text-xs uppercase tracking-widest text-ink-muted font-body mt-1">
                      Ans de métier
                    </p>
                  </div>
                  <div>
            ...
            <div className="animate-fade-up space-y-6">
              ...
              <div className="flex items-center gap-4 pt-4">
                ...
                <div className="text-center px-4">
                  ...
                  <p className="text-xs uppercase tracking-widest text-gold font-body mt-1">
                    Heures de travail
                  </p>
                </div>
                <div className="flex-1 h-px bg-border" />
            ...
            <div className="animate-fade-up delay-200">
              <div className="relative aspect-video bg-warm-gray overflow-hidden group cursor-pointer">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  ...
                  {/* Play button */}
                  <div className="relative z-10 w-16 h-16 rounded-full bg-cream/90 backdrop-blur-sm flex items-center justify-center group-hover:bg-gold/90 transition-all duration-300 group-hover:scale-110 shadow-lg">
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 20 20"
                ...
                {/* Caption */}
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-ink/60 to-transparent p-5">
                ...
                {/* Corner ornaments */}
                <div className="absolute top-4 left-4 w-6 h-6 border-t border-l border-gold/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                <div className="absolute bottom-4 right-4 w-6 h-6 border-b border-r border-gold/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              </div>

              <p className="text-xs text-ink-muted font-body mt-3 text-center">
      ...
      <section className="border-t border-border bg-cream-dark">
        <div className="max-w-screen-xl mx-auto px-6 md:px-12 lg:px-20 py-20">
          <p className="text-xs uppercase tracking-widest text-gold font-body mb-4 animate-fade-up">
            Spécifications
          </p>
          <h2 className="font-display text-3xl md:text-4xl text-ink mb-12 animate-fade-up delay-100">
            Détails Techniques
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-20 gap-y-0 animate-fade-up delay-200">
            {/* Left column */}
            <div>
          ...
          <div className="mt-12 p-6 border border-border bg-cream">
        ...
        <section className="border-t border-border">
          <div className="max-w-screen-xl mx-auto px-6 md:px-12 lg:px-20 py-20">
            <div className="flex items-baseline justify-between mb-12">
              <div>
                <p className="text-xs uppercase tracking-widest text-gold font-body mb-3">
                  Découvrir aussi
                </p>
            ...
            <div className="flex gap-8 overflow-x-auto no-scrollbar pb-4 lg:grid lg:grid-cols-4 lg:overflow-visible lg:pb-0">
              {related.map((p, i) => (
                <div key={p.id} className="min-w-[280px] lg:min-w-0">
                  <ProductCard product={p} animationDelay={i * 100} />
                </div>
              ))}
            </div>
          </div>
...
function TechRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex gap-6 py-4 border-b border-border/60 last:border-b-0">
      <dt className="text-xs uppercase tracking-widest text-ink-muted font-body shrink-0 w-28 pt-0.5">
        {label}
      </dt>
